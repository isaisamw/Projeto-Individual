...
(default, 'Fashionista', 'Você arrasa no estilo, assim como o Justin com seus looks babadeiros! A moda é sua forma de expressão, você está sempre por dentro das tendências e adora montar produções que refletem sua personalidade. Você é um ícone de estilo e influencia todos ao seu redor com seu bom gosto.');